...
<main>
    ...
    <div class="hold-account-info">
      ...
      <button>Login</button>
        <fieldset class="login">
          ...
          <form action="submitSignup" method="post">
            <label class="top">Username*: <input type="text" name="username"
                                                          title="Put your username" ></label>
            <label class="top">Password*: <input type="password" name="password"
      ...
      <fieldset class="signup">
        ...
        <form action="submitSignup" method="post">
          <label class="top">First Name*: <input type="text" name="firstname" required pattern="[A-Za-z ]+" minlength="5"
